...
// Custom Project Imagery
import ecotechImg from '../assets/EcoTechFramework.webp';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-sm text-slate-400 mt-3">
            A selection of projects across high-reliability systems, real-time controls, AI research, and cloud architectures.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filteredProjects.map((project) => {
            const projectImage = customProjectImages[project.id] || project.image;

            return (
              <div
                key={project.id}
                className="flex flex-col rounded-2xl bg-slate-900/60 border border-slate-800 overflow-hidden hover:border-slate-700 hover:shadow-2xl transition-all group"
              >
                {/* Project Image */}
